...
package torch.sklearn.feature.transformers

import java.net.{URLDecoder, URLEncoder}

import torch.sklearn.feature.{FeatureBuilder, FeatureRejection, FlatReader, FlatWriter}
...
private[feature] class OneHotEncoder(name: String, encodeMissingValue: Boolean)
...
private[feature] object MissingValue {
  val MissingValueToken = "__missing__"
}

abstract private[feature] class BaseHotEncoder[A](name: String, encodeMissingValue: Boolean)
