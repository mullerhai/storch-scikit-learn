...
import torch.sklearn.feature.transformers.{MDLRecord, Settings, WeightedLabel}
import torch.sklearn.feature.{FlatReader, FlatWriter}
import io.circe._
import io.circe.parser.{decode => circeDecode}
import io.circe.syntax._

private[feature] trait Implicits extends Serializable {
...
private[feature] object Implicits extends Implicits
