...
import torch.sklearn.feature.transformers.{MDLRecord, WeightedLabel}
...
private[feature] class FlatConverter[T: ClassTag, A: ClassTag: FlatWriter](spec: FeatureSpec[T])
