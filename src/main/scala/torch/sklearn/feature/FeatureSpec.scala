...
import torch.sklearn.feature.transformers.{Settings, Transformer}

import scala.collection.mutable
import scala.reflect.ClassTag
import torch.sklearn.feature.converters.{CaseClassConverter, DefaultTransform}
...
object FeatureSpec extends FeatureSpecCompat {
  private[feature] type ARRAY = Array[Option[Any]]
...
class FeatureSpec[T] private[feature](
   ...
   * @param t
   *   [[torch.feature.transformers.Transformer Transformer]] for extracted feature `A`
   * @tparam A
...
class Feature[T, A, B, C] private[feature](
  val f: T => Option[A],
